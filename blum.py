...
async def main():
    banner = f"""
    {green}=====================================================
    {green}                  AIRDROP UNLIMITED                        
    {green}=====================================================
    {green}        Bot : Blum Auto
    {green}        Telegram Channel : @unlimited_airdrop
    {green}        Telegram Group : @airdrop_discussion
    {"bgColor":"#000000","density":"@BOo:.","fgColor":"#FFFFFF","fgColorType":-1,"name":"White on black"}  
    {green}=====================================================
        """
